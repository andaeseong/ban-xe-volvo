...
import { Car, CreditCard, Calculator, ArrowRight, CheckCircle, Sparkles, Award } from 'lucide-react';
              ...
              <div className="double-bezel-inner p-5 sm:p-6 space-y-5">
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-[13px] font-medium text-slate-500 dark:text-slate-400">{volvoCars.length} mẫu xe • Cập nhật 2026</p>
                  </div>
                ...
                <div className="rounded-2xl bg-slate-50 border border-slate-200 p-4 space-y-3 dark:bg-slate-800/50 dark:border-slate-700">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="inline-flex items-center gap-1.5 rounded-full bg-white border border-slate-200 px-2.5 py-1 text-xs font-semibold shadow-sm dark:bg-slate-900 dark:border-slate-700">
                      <span className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse" /> Có sẵn
                    </span>
                  </div>
                  ...
                  <div className="flex items-center gap-2.5 rounded-xl bg-[#003057] px-3.5 py-2.5 text-white dark:bg-slate-900 dark:border dark:border-slate-700">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-[11px] font-medium text-white/80 dark:text-slate-400">Duyệt trong ngày • Giao toàn quốc</p>
                    </div>
                  </div>
                </div>
              </div>
